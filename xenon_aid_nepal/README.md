...
```
xenon_aid_nepal/
├── xenon_aid_nepal_v2.py     # Main PyQt6 application with Liquid Glass UI & Nepali Localization
├── xenon_aid_nepal_data.json # Seed database (Hospitals, 16 Doctors, Users, Appointments, Prescriptions)
