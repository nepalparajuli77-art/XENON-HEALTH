#!/usr/bin/env python3
"""
Xenon Aid Nepal v2.0 — Glassmorphism Edition
...
APP_DATA_FILE = os.path.join(os.path.dirname(__file__), "xenon_aid_nepal_data.json")
...
TRANSLATIONS = {
    # App General
    "app_title": {"en": "Xenon Aid Nepal — Smart Healthcare Portal", "np": "जेनन एड नेपाल — स्मार्ट स्वास्थ्य सेवा पोर्टल"},
    ...
    # Auth
    "login_title": {"en": "Xenon Aid Nepal — Sign In", "np": "जेनन एड नेपाल — लगइन"},
...
class TelemedNepalApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.brand_title = QLabel("Xenon Aid Nepal (जेनन एड नेपाल)")
        ...
        self.status_bar.showMessage("🟢 Xenon Aid Nepal v2.0 Online — Connected to National Health Grid")
